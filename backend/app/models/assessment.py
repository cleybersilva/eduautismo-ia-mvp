...
class Assessment(BaseModel):
    ...
    engagement_level: Mapped[EngagementLevel] = mapped_column(
        SQLEnum(EngagementLevel, name="engagement_level"),
        nullable=False
    )
    
    difficulty_rating: Mapped[DifficultyRating] = mapped_column(
        SQLEnum(DifficultyRating, name="difficulty_rating"),
        nullable=False
    )
    ...
    notes: Mapped[str | None] = mapped_column(
        Text,
        nullable=True,
        comment="Teacher's observations and notes"
    )
    
    strengths_observed: Mapped[str | None] = mapped_column(
        Text,
        nullable=True,
        comment="What the student did well"
    )
    
    challenges_observed: Mapped[str | None] = mapped_column(
        Text,
        nullable=True,
        comment="Difficulties encountered"
    )
    ...
    recommendations: Mapped[str | None] = mapped_column(
        Text,
        nullable=True,
        comment="Suggestions for future activities"
    )
    ...
    def needs_adjustment(self) -> bool:
        ...
        return self.difficulty_rating in [
