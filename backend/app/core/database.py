...
# Async PostgreSQL
async_database_url = settings.DATABASE_URL.replace("postgresql://", "postgresql+asyncpg://") if not settings.DATABASE_URL.startswith("postgresql+asyncpg") else settings.DATABASE_URL
