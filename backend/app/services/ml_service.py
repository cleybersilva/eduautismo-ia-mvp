...
class MLService:
    ...
    def _generate_success_recommendations(self, features: Dict[str, float], success_prob: float) -> List[str]:
        ...
        if success_prob < 0.4:
            recommendations.append("⚠️ Atividade pode ser desafiadora - considere simplificar")
        ...
        if duration > 45 and attention_span < 3:
            recommendations.append("Considere dividir atividade em sessÃµes menores")
    ...
    def analyze_student_progress(
        ...
        if not assessments:
            return {
                ...
                "message": "NÃ£o hÃ¡ avaliaÃ§Ãµes suficientes para anÃ¡lise",
            }
    ...
    def _generate_progress_insights(self, assessments: List[Assessment]) -> List[str]:
        ...
        if not assessments:
            return ["NÃ£o hÃ¡ dados suficientes para gerar insights"]
        ...
        if completion_rate > 0.8:
            ...
            insights.append("⚠️ Baixa taxa de conclusão - considere ajustar dificuldade")
        ...
        if recent_completed == len(recent):
            ...
            insights.append("⚠️ Nenhuma atividade recente foi concluída - necessário suporte adicional")
